...
mib_2, Bits, TimeTicks, IpAddress, iso, Unsigned32, NotificationType, Integer32, MibIdentifier, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "TimeTicks", "IpAddress", "iso", "Unsigned32", "NotificationType", "Integer32", "MibIdentifier", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "ObjectIdentity")
DisplayString, TimeStamp, TextualConvention, PhysAddress, TestAndIncr, AutonomousType, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "PhysAddress", "TestAndIncr", "AutonomousType", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliance3=ifCompliance3, ifPacketGroup=ifPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTableLastChange=ifTableLastChange, ifHCInOctets=ifHCInOctets, OwnerString=OwnerString, ifHCPacketGroup=ifHCPacketGroup, ifStackStatus=ifStackStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliances=ifCompliances, PYSNMP_MODULE_ID=ifMIB, ifEntry=ifEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTable=ifTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifPromiscuousMode=ifPromiscuousMode, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackLastChange=ifStackLastChange, ifOutQLen=ifOutQLen, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifSpeed=ifSpeed, ifFixedLengthGroup=ifFixedLengthGroup, ifStackEntry=ifStackEntry, ifOperStatus=ifOperStatus, InterfaceIndex=InterfaceIndex, ifTestType=ifTestType, ifIndex=ifIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifInUcastPkts=ifInUcastPkts, interfaces=interfaces, ifInNUcastPkts=ifInNUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHighSpeed=ifHighSpeed, ifStackHigherLayer=ifStackHigherLayer, ifDescr=ifDescr, ifStackGroup=ifStackGroup, ifTestOwner=ifTestOwner, ifSpecific=ifSpecific, ifInDiscards=ifInDiscards, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGeneralGroup=ifGeneralGroup, ifConnectorPresent=ifConnectorPresent, ifCompliance=ifCompliance, ifTestTable=ifTestTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestStatus=ifTestStatus, ifAdminStatus=ifAdminStatus, ifInMulticastPkts=ifInMulticastPkts, ifStackGroup2=ifStackGroup2, ifOutDiscards=ifOutDiscards, ifOutErrors=ifOutErrors, linkUp=linkUp, ifVHCPacketGroup=ifVHCPacketGroup, ifInOctets=ifInOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifCompliance2=ifCompliance2, linkDown=linkDown, ifXTable=ifXTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifLastChange=ifLastChange, ifMIBObjects=ifMIBObjects, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressType=ifRcvAddressType, ifHCOutOctets=ifHCOutOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifType=ifType, ifOldObjectsGroup=ifOldObjectsGroup, ifTestResult=ifTestResult, ifRcvAddressAddress=ifRcvAddressAddress, ifInBroadcastPkts=ifInBroadcastPkts, ifTestCode=ifTestCode, ifStackTable=ifStackTable, ifGroups=ifGroups, ifTestEntry=ifTestEntry, ifMIB=ifMIB, ifOutUcastPkts=ifOutUcastPkts, ifNumber=ifNumber, ifOutOctets=ifOutOctets, ifTestId=ifTestId, ifInErrors=ifInErrors, ifName=ifName, ifTestGroup=ifTestGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifAlias=ifAlias, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifMtu=ifMtu, ifPhysAddress=ifPhysAddress, ifConformance=ifConformance, ifXEntry=ifXEntry)
